...
RSpec.describe InvoiceLinesController, :type => :controller do
  ...
  # InvoiceLinesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all invoice_lines as @invoice_lines" do
      ...
      expect(assigns(:invoice_lines)).to eq([invoice_line])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested invoice_line as @invoice_line" do
      invoice_line = InvoiceLine.create! valid_attributes
      get :show, {:id => invoice_line.to_param}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created invoice_line as @invoice_line" do
        post :create, {:invoice_line => valid_attributes}, valid_session
        expect(assigns(:invoice_line)).to be_a(InvoiceLine)
